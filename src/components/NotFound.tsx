...
const NotFound = () => {
  return (
    <main className="flex-1 grid place-content-center gap-4 text-center">
      <h2 className="text-7xl">404</h2>
      <section role="alert" className="flex gap-4 items-center">
        <svg
          fill="#f8f8f8"
          width="64px"
          height="64px"
        ...
        <p className="text-4xl">Uh-oh! Something went wrong!</p>
      </section>
      <Link to="/" className="text-xl underline hover:text-blue-600">
        Back to homepage
      </Link>
    </main>
  );
